...
export const GLM_PERMISSION_MODES = ['default', 'yolo'] as const
export type GlmPermissionMode = typeof GLM_PERMISSION_MODES[number]

export type AgentFlavor = 'claude' | 'codex' | 'gemini' | 'opencode' | 'cursor' | 'glm'
