export default {
  ...
  'login.changePassword.title': '设置新密码',
  'login.changePassword.description': '必须先修改默认密码才能继续。',
  'login.changePassword.current': '当前密码',
  'login.changePassword.new': '新密码（至少 6 位）',
  'login.changePassword.confirm': '确认新密码',
  'login.changePassword.submit': '保存密码',
  'login.changePassword.submitting': '保存中…',
  'login.changePassword.mismatch': '两次密码不一致',
  'login.changePassword.tooShort': '密码至少 6 位',
  'login.changePassword.sameAsCurrent': '新密码不能与当前密码相同',
