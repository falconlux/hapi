export default {
  ...
  'session.group.deleteDescription': '确定删除“{name}”吗？组内会话将回到未分组，不会删除会话。',
  'session.group.namePlaceholder': '分组名称',
  'session.group.nameDescription': '输入会话分组名称。',
  'session.group.saveError': '保存分组失败，请重试。',
  'session.group.loadError': '加载会话分组失败。',
  'session.group.moveTitle': '移动到分组',
  'session.group.moveDescription': '选择该会话要移动到的分组。',
  'session.group.move': '移动',
  'session.group.moving': '移动中…',
  'session.group.moveError': '移动会话失败，请重试。',
  'session.group.deleting': '删除中…',
  'session.group.thinkingCount': '{n} 个思考中',
  'session.group.pendingCount': '{n} 个待处理',
  ...
  'toolGroup.friendly.inspectAndEdit': '检查并修改项目',
  'toolGroup.friendly.inspectAndEditTarget': '检查并修改 {target}',
  'toolGroup.meta.current': '当前：{target}',
  'toolGroup.meta.waiting': '等待：{target}',
  'toolGroup.meta.moreTargets': '{target} +{n}',
  'toolGroup.meta.steps': '{n} 步',
  'toolGroup.status.completed': '完成',
  'toolGroup.status.running': '进行中',
  'toolGroup.status.pending': '等待中',
  'toolGroup.status.error': '{n} 失败',
  ...
  'settings.about.clearCache': '清理缓存并重新加载',
