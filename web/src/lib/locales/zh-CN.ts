export default {
  ...
  'agentProgress.objective': '目标',
  'agentProgress.planCount': '计划 {completed}/{total}',
  'agentProgress.workCount': '已完成 {phases} 个阶段 · {actions} 项操作',
  'agentProgress.action.thinking': '正在分析结果并决定下一步',
  'agentProgress.action.inspect': '正在查看项目文件',
  'agentProgress.action.search': '正在搜索代码和项目内容',
  'agentProgress.action.command': '正在执行项目命令',
  'agentProgress.action.edit': '正在修改项目文件',
  'agentProgress.action.browser': '正在浏览器中操作并检查应用',
  'agentProgress.action.screenshot': '正在截图进行视觉验收',
  'agentProgress.action.tests': '正在运行自动化测试',
  'agentProgress.action.verify': '正在构建或校验项目',
  'agentProgress.action.deploy': '正在部署或发布项目',
