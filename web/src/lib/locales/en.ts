export default {
  ...
  'login.changePassword.title': 'Set a new password',
  'login.changePassword.description': 'You must change the default password before continuing.',
  'login.changePassword.current': 'Current password',
  'login.changePassword.new': 'New password (min 6 chars)',
  'login.changePassword.confirm': 'Confirm new password',
  'login.changePassword.submit': 'Save password',
  'login.changePassword.submitting': 'Saving…',
  'login.changePassword.mismatch': 'Passwords do not match',
  'login.changePassword.tooShort': 'Password must be at least 6 characters',
  'login.changePassword.sameAsCurrent': 'New password must differ from current password',
