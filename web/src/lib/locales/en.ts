export default {
  ...
  'agentProgress.objective': 'Goal',
  'agentProgress.planCount': 'Plan {completed}/{total}',
  'agentProgress.workCount': '{phases} phases · {actions} actions done',
  'agentProgress.action.thinking': 'Analyzing results and deciding the next action',
  'agentProgress.action.inspect': 'Inspecting project files',
  'agentProgress.action.search': 'Searching code and project content',
  'agentProgress.action.command': 'Running a project command',
  'agentProgress.action.edit': 'Editing project files',
  'agentProgress.action.browser': 'Operating and checking the app in a browser',
  'agentProgress.action.screenshot': 'Capturing a screenshot for visual verification',
  'agentProgress.action.tests': 'Running automated tests',
  'agentProgress.action.verify': 'Building or verifying the project',
  'agentProgress.action.deploy': 'Deploying or publishing the project',
  ...
  'toolGroup.friendly.inspectAndEdit': 'Inspect and edit project',
  'toolGroup.friendly.inspectAndEditTarget': 'Inspect and edit {target}',
  'toolGroup.meta.current': 'Current: {target}',
  'toolGroup.meta.waiting': 'Waiting: {target}',
  'toolGroup.meta.moreTargets': '{target} +{n}',
  'toolGroup.meta.steps': '{n} steps',
  'toolGroup.status.completed': 'Done',
  'toolGroup.status.running': 'Running',
  'toolGroup.status.pending': 'Waiting',
  'toolGroup.status.error': '{n} failed',
