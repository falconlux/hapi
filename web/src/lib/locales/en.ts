export default {
  ...
  'session.group.ungrouped': 'Ungrouped',
  ...
  'session.group.deleteDescription': 'Delete “{name}”? Its sessions will return to Ungrouped and will not be deleted.',
  'session.group.namePlaceholder': 'Group name',
  'session.group.nameDescription': 'Enter a name for this session group.',
  'session.group.saveError': 'Failed to save group. Please try again.',
  'session.group.loadError': 'Failed to load session groups.',
  'session.group.moveTitle': 'Move to group',
  'session.group.moveDescription': 'Choose a destination group for this session.',
  'session.group.move': 'Move',
  'session.group.moving': 'Moving…',
  'session.group.moveError': 'Failed to move session. Please try again.',
  'session.group.deleting': 'Deleting…',
  'session.group.thinkingCount': '{n} thinking',
  'session.group.pendingCount': '{n} pending',
